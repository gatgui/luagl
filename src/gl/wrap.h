...
#define LUAGL_FUNC_AS_ARG

#ifndef LUAGL_FUNC_AS_ARG

// This doesn't work with MSVC

template <void (CALLBACK *func)()>
struct WrapFunc0 {
...
template <typename A,
          void (CALLBACK *func)(typename A::T)>
struct WrapFunc1 {
  static inline int Call(lua_State *L) {
    CHECK_ARG_COUNT(L, 1);
    A arg0(L, 1);
...
template <typename A, typename B,
          void (CALLBACK *func)(typename A::T, typename B::T)>
struct WrapFunc2 {
  static inline int Call(lua_State *L) {
    CHECK_ARG_COUNT(L, 2);
    A arg0(L, 1);
...
template <typename A, typename B, typename C,
          void (CALLBACK *func)(typename A::T, typename B::T, typename C::T)>
struct WrapFunc3 {
  static inline int Call(lua_State *L) {
    CHECK_ARG_COUNT(L, 3);
    A arg0(L, 1);
